      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        {!isAuthenticated &&
          <div className="pb-12">
            ...
            <div className="flex flex-col w-full items-center justify-center space-y-4 relative pt-4">
              <div className="relative group">
                ...
                <button onClick={authenticate} className="relative px-10 py-2 font-medium rounded-full text-white bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">{!isAuthenticating ? "Sign up" : "Authenticating..."}</button>
              </div>
            </div>
          </div>
        }
        ...
        <div className="mt-10 md:flex md:items-center md:justify-between">
          {/* <ul className="flex items-center justify-center space-x-6 md:order-2 md:justify-end">
            <li>
              <a href="#" title="" className="text-base font-normal text-gray-600 transition-all duration-200 font-pj hover:text-gray-900">
                Privacy Policy
              </a>
            </li>

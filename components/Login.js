    ...
    <div className="relative max-w-4xl m-auto mt-48 mb-64 h-full">
      ...
      <div className="flex flex-col w-full items-center justify-center space-y-4 relative">
        ...
        <div className="relative group">
          ...
          <button onClick={authenticate} className="relative px-4 py-2 font-medium rounded-full text-white bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">{!isAuthenticating ? "Claim My Profile" : "Authenticating..."}</button>
        </div>
      </div>
    </div>
  )

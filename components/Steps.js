          ...
          <div className="flex flex-col items-center max-w-md mx-auto mt-8 lg:mt-20 lg:flex-row lg:max-w-none">
            ...
            <div className="relative flex-1 w-full ">
              <div className="absolute -inset-4">
                <div className="w-full h-full mx-auto rotate-180 blur-lg filter opacity-20" style={{background: "linear-gradient(90deg, #44FF9A -0.55%, #44B0FF 22.86%, #8B44FF 48.36%, #FF6644 73.33%, #EBFF70 99.34%)"}}></div>
              </div>
